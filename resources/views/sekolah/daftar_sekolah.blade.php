                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class='form-group row mb-4'> <label
                                    ...
                                    <div class='col-sm-12 col-md-7'>
                                        <input id='id' type='hidden' class='form-control' placeholder='npsn'
                                            name='id' value=''>
                                        <input disabled id='npsn' type='text' class='form-control'
                                            placeholder='npsn' name='npsn' value=''>
                                ...
                                <div class='form-group row mb-4'> <label
                                    ...
                                    <div class='col-sm-12 col-md-7'> <input disabled id='nama_satuan_pendidikan'
                                            type='text' class='form-control' placeholder='nama_satuan_pendidikan'
                                ...
                                <div class='form-group row mb-4'> <label
                                    ...
                                    <div class='col-sm-12 col-md-7'>
                                        <input id='hpks' type='text' class='form-control'
                                            placeholder='No HP Kepala Sekolah' name='hpks' value=''>
                                ...
                                $.ajax({
                                    ...
                                    error: function(data) {
                                        ...
                                        $('#errkcmtn').text(data
                                            .responseJSON.errors
                                            .kecamatan);
                                        $('#errhpks').text(data.responseJSON
                                            .errors.hpks);
                                        $('#errhppj').text(data.responseJSON
                                            .errors.hppj);
                                        $('#erralmt').text(data.responseJSON
                                            .errors.alamat);
                                        $('#errklrhn').text(data
                                            .responseJSON.errors
                                            .kelurahan);
                                        $('#errfile').text(data.responseJSON
                                            .errors.ijop);
